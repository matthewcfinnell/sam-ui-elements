...
describe('The Sam Checkboxes component', () => {
  ...
  describe('rendered tests', () => {
    ...
    it('should display 3 checkboxes if 3 options are specified by the config',
      function () {
    ...
    it('should select all elements if select all is checked', async(() => {
      ...
      const selectAllElement =
        fixture.nativeElement.getElementsByTagName('input')[0];
    ...
    it('should deselect all elements if select all is checked twice',
      async(() => {
      component.hasSelectAll = true;
      fixture.detectChanges();
      const selectAllElement =
    ...
    it('should allow an initial value to be set by the model input',
      ...
      fixture.detectChanges();
      setTimeout(() => {
        const inputs = fixture.debugElement.queryAll(By.css(':checked'));
    ...
    it('should work with a formcontrol', () => {
      const c = new FormControl('', (_) => { return undefined; });
      component.control = c;
      component.options = [
        {
          label: 'test',
